  ...
  return (
    <Fragment>
      <div className="content fuct">
        {/* title */}
        <div className="title">Curiosidades</div>
        {/* content */}
        <div className="row fuct-items">
          ...
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              <div className="icon">
                <span className="fa fa-pagelines" />
              </div>
              <div className="name">Jardinagem e Terrários</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">Programador desde o mIRC</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">Técnico de Áudio e Guitarrista</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">Voluntário em <a href="https://iris.org.br/inicio/" target="_blank" rel="noopener noreferrer">IRIS Cão Guia</a></div>
            </div>
          </div>
          <div className="clear" />
        </div>
